...
class ClassSubject(models.Model):
    ...
    lecturer1 = models.ForeignKey(Lecturer, on_delete=models.SET_NULL, null=True, blank=True, related_name='class_lecturer1', verbose_name='Giảng viên 1')
    lecturer2 = models.ForeignKey(Lecturer, on_delete=models.SET_NULL, null=True, blank=True, related_name='class_lecturer2', verbose_name='Giảng viên 2')
